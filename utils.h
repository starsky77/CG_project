...
void renderCube()
{
	unsigned int cube_tex = loadTexture("container2.png");
	glActiveTexture(GL_TEXTURE0);
...
void renderCube_2()
{
	static unsigned int cube_tex = loadTexture("brickwall.jpg");
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, cube_tex);
	renderCube(0);
}
...
void renderCube_3()
{
	static unsigned int cube_tex = loadTexture("container.jpg");
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, cube_tex);
	renderCube(0);
}
